...
% Load mat files.
load /Users/henridrake/Scripts/Matlab/mat/1.mat
load /Users/henridrake/Scripts/Matlab/mat/1_qc.mat
load /Users/henridrake/Scripts/Matlab/mat/1_err.mat
load /Users/henridrake/Scripts/Matlab/mat/1_adj.mat

% Clear unnecessary variables
clear dir_name ind float_num
...
figure(1); clf
axesm('mercator','MapLatLimit',[-85 85],'MapLonLimit',[-280 80])
plotm(latitude,longitude,'.');
geoshow('landareas.shp','FaceColor',[.9 .9 .9])
setm(gca, 'grid','on','meridianlabel','on','parallellabel','on','plinelocation',5,'mlinelocation',5,'plabellocation',5,'mlabellocation',20)
axis tight
[selected_lat1,selected_lon1] = inputm(1)
[selected_lat2,selected_lon2] = inputm(1)
...
save /Users/Scripts/Matlab/mat/bad_floats.mat num_800
clear num_800 maxp
...
save /Users/Scripts/Matlab/mat/tmp.mat


%% graylist floats

% Name of the file that is an index of all the graylist floats
prof_file = 'ar_greylist.txt';
...
if getlist_flag == 1
    ...
    disp('Please check ar_greylist.txt for NaN''s and text.  Put ''#'' in front of unnecessary lines.');
    disp('Press any key to resume');
    pause
end


cd('/Users/Scripts/Matlab/argo_scripts/')
[grayfloat,~,start_date,end_date,errtype] = graylist();
...
save /Users/Scripts/Matlab/mat/bad_floats.mat num_800_2
...
save /Users/Scripts/Matlab/mat/bad_floats.mat num_shortprof -APPEND
clear num_shortprof
...
save /Users/Scripts/Matlab/mat/bad_floats.mat num_gray -APPEND
...
%% graylist floats (What is graylist?)
