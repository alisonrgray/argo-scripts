%% north pacific profile interpolation;

clear; pack

load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/North' Pacific'/prof_2005_qc.mat
fnum2 = fnum; latitude2 = latitude; longitude2 = longitude; time2 = time; type2 = type;
temp2 = NaN(1086,  138978); psal2 = NaN(1086, 138978); pres2 = NaN(1086, 138978); datamode2 = datamode;
temp2_err = NaN(1086, 138978); psal2_err = NaN(1086, 138978); pres2_err = NaN(1086, 138978);
[m,n] = size(pres);
...
load /home/alison/Matlab/M'at files'/Global' Mapping 2'/North' Pacific'/prof_2006_qc.mat
...
load /home/alison/Matlab/M'at files'/Global' Mapping 2'/North' Pacific'/prof_2007_qc.mat
fnum2 = [fnum2; fnum]; latitude2 = [latitude2; latitude]; longitude2 = [longitude2; longitude];
time2 = [time2; time]; type2 = [type2; type]; datamode2 = [datamode2; datamode];
[mmm,nnn] = size(pres);
...
load /home/alison/Matlab/M'at files'/Global' Mapping 2'/North' Pacific'/prof_2008_qc.mat
fnum2 = [fnum2; fnum]; latitude2 = [latitude2; latitude]; longitude2 = [longitude2; longitude];
time2 = [time2; time]; type2 = [type2; type]; datamode2 = [datamode2; datamode];
[mmmm,nnnn] = size(pres);
...
load /home/alison/Matlab/M'at files'/Global' Mapping 2'/North' Pacific'/prof_2009_qc.mat
fnum2 = [fnum2; fnum]; latitude2 = [latitude2; latitude]; longitude2 = [longitude2; longitude];
time2 = [time2; time]; type2 = [type2; type]; datamode2 = [datamode2; datamode];
[m5,n5] = size(pres);
...
load /home/alison/Matlab/M'at files'/Global' Mapping 2'/North' Pacific'/prof_2010_qc.mat
fnum2 = [fnum2; fnum]; latitude2 = [latitude2; latitude]; longitude2 = [longitude2; longitude];
time2 = [time2; time]; type2 = [type2; type]; datamode2 = [datamode2; datamode];
[m6,n6] = size(pres);
...
save /home/alison/Matlab/Mat' files'/Global' Mapping 2'/North' Pacific'/profiles_interp.mat
...
ind = find(sum(isnan(pres),1)~=1086);
...
%% 
clear; pack;
load /home/alison/Matlab/Mat' files'/Global' Mapping 2'/North' Pacific'/profiles_interp.mat
fnum2 = fnum; latitude2 = latitude; longitude2 = longitude; time2 = time; type2 = type;
temp2 = temp; psal2 = psal; pres2 = pres;

load /home/alison/Matlab/Mat' files'/Global' Mapping'/North' Pacific'/profiles_final.mat
fnum3 = fnum; latitude3 = latitude; longitude3 = longitude; time3 = time; 
temp3 = temp; psal3 = psal; pres3 = pres;

load /home/alison/Matlab/Mat' files'/Global' Mapping'/North' Pacific'/profiles.mat
...
for i = 1:length(bad)
    if bad(i) == 0
        ...
        figure(1); clf; hold on;
        plot(ss(:,ii),-pp(:,ii),'.-','color',[.7 .7 .7]);
        plot(ss(:,i),-pp(:,i),'r.-'); grid on;
        figure(2); clf; hold on;
        plot(tt(:,ii),-pp(:,ii),'.-','color',[.7 .7 .7]);
        plot(tt(:,i),-pp(:,i),'r.-'); grid on;
...
for i = 1:length(ind)
    if ~isempty(badind(i,1))
        iii = find(pres2(:,ind(i)) <= badind(i,2) & pres2(:,ind(i)) >= badind(i,1));
        pres2(iii,ind(i)) = NaN;
    end
end
...
save /home/alison/Matlab/Mat' files'/Global' Mapping 2'/North' Pacific'/profiles_final.mat
