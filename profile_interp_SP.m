%% south pacific profile interpolation;

clear; pack

load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Pacific'/prof_2005_qc.mat
fnum2 = fnum; latitude2 = latitude; longitude2 = longitude; time2 = time; type2 = type;
temp2 = NaN(1053,  157947); psal2 = NaN(1053, 157947); pres2 = NaN(1053, 157947); datamode2 = datamode;
temp2_err = NaN(1053, 157947); psal2_err = NaN(1053, 157947); pres2_err = NaN(1053, 157947);
[m,n] = size(pres);
...
load /home/alison/Matlab/M'at files'/Global' Mapping 2'/South' Pacific'/prof_2006_qc.mat
...
load /home/alison/Matlab/M'at files'/Global' Mapping 2'/South' Pacific'/prof_2007_qc.mat
fnum2 = [fnum2; fnum]; latitude2 = [latitude2; latitude]; longitude2 = [longitude2; longitude];
time2 = [time2; time]; type2 = [type2; type]; datamode2 = [datamode2; datamode];
[mmm,nnn] = size(pres);
...
load /home/alison/Matlab/M'at files'/Global' Mapping 2'/South' Pacific'/prof_2008_qc.mat
fnum2 = [fnum2; fnum]; latitude2 = [latitude2; latitude]; longitude2 = [longitude2; longitude];
time2 = [time2; time]; type2 = [type2; type]; datamode2 = [datamode2; datamode];
[mmmm,nnnn] = size(pres);
...
load /home/alison/Matlab/M'at files'/Global' Mapping 2'/South' Pacific'/prof_2009_qc.mat
fnum2 = [fnum2; fnum]; latitude2 = [latitude2; latitude]; longitude2 = [longitude2; longitude];
time2 = [time2; time]; type2 = [type2; type]; datamode2 = [datamode2; datamode];
[m5,n5] = size(pres);
...
load /home/alison/Matlab/M'at files'/Global' Mapping 2'/South' Pacific'/prof_2010_qc.mat
fnum2 = [fnum2; fnum]; latitude2 = [latitude2; latitude]; longitude2 = [longitude2; longitude];
time2 = [time2; time]; type2 = [type2; type]; datamode2 = [datamode2; datamode];
[m6,n6] = size(pres);
...
save /home/alison/Matlab/Mat' files'/Global' Mapping 2'/South' Pacific'/profiles_interp.mat
...
for i = 1:length(fnum)
    ...
    if dp(jj(end)) < 10 && dp(jj(end-9)) > 10
...
%     figure(1); clf
%     plot(repmat((1:length(ind)),1053,1),-pres(:,ind),'.-');
...
%     pause
%     if rem(i,10)==0
%         save /home/alison/Matlab/Mat' files'/Global' Mapping 2'/North' Pacific'/tmp.mat
%     end
end
...
ind = find(sum(isnan(pres),1)~=1053);
...
%% 
clear; pack;
load /home/alison/Matlab/Mat' files'/Global' Mapping 2'/South' Pacific'/profiles_interp.mat
fnum2 = fnum; latitude2 = latitude; longitude2 = longitude; time2 = time; type2 = type;
temp2 = temp; psal2 = psal; pres2 = pres;

load /home/alison/Matlab/Mat' files'/Global' Mapping'/South' Pacific'/profiles_final.mat
fnum3 = fnum; latitude3 = latitude; longitude3 = longitude; time3 = time; type3 = type;
temp3 = temp; psal3 = psal; pres3 = pres;

load /home/alison/Matlab/Mat' files'/Global' Mapping'/South' Pacific'/profiles.mat
...
k = 1; ind4 = [];
for i = 1:length(ind3)
    ii = find(fnum3 == fnum2(ind3(i)) & abs(latitude3 - latitude2(ind3(i))) < .5 & abs(longitude3 - longitude2(ind3(i))) < .5 & abs(time3-time2(ind3(i))) < .25);
    ind4(k) = ii; k = k+1;
end    

ft = fittype('pchipinterp');
bad = NaN(length(p2),1);
for i = 1449:length(p2)
...
%         plot(dd,-pp,'r.');
        ...
        iii = isnan(pp(1:1053)) & ~isnan(p);
        pres2(iii,ind3(i)) = NaN;
    end
...
pres2(:,22487) = NaN;
pres2(:,22491) = NaN;
pres2(1:11,27909) = NaN;
pres2(:,45112) = NaN;
pres2(:,45178) = NaN;
pres2(1:17,45206) = NaN;
pres2(:,45227) = NaN;
pres2(1:21,45233) = NaN;
pres2(:,45236) = NaN;
pres2(:,45239) = NaN;
pres2(:,45241) = NaN;
pres2(:,45242) = NaN;
pres2(:,45245) = NaN;
pres2(1:2,45248) = NaN;
pres2(1:10,45250) = NaN;
pres2(:,45251) = NaN;
pres2(1:20,45253) = NaN;
pres2(:,71765) = NaN;
pres2(:,71773) = NaN;
pres2(:,71775) = NaN;
pres2(1:16,71789) = NaN;
pres2(:,71790) = NaN;
pres2(:,71791) = NaN;
pres2(1:23,71857) = NaN;
pres2(:,71869) = NaN;
pres2(:,71882) = NaN;
pres2(1:9,71888) = NaN;
pres2(1:8,71891) = NaN;
pres2(:,101907) = NaN;
pres2(1:20,101991) = NaN;
pres2(:,101994) = NaN;
pres2(:,102016) = NaN;
pres2(:,102017) = NaN;
pres2(:,102026) = NaN;
pres2(1:4,102040) = NaN;
pres2(1:7,102041) = NaN;
pres2(1:17,102118) = NaN;
pres2(:,102123) = NaN;
pres2(:,102125) = NaN;
pres2(:,102134) = NaN;
pres2(:,102137) = NaN;
pres2(:,102139) = NaN;
pres2(:,106426) = NaN;
pres2(1:5,125163) = NaN;
pres2(1:14,131930) = NaN;
pres2(1:20,131961) = NaN;
pres2(:,131968) = NaN;
pres2(:,131981) = NaN;
pres2(:,132064) = NaN;
pres2(1:11,132065) = NaN;
pres2(1:9,132087) = NaN;
pres2(1:20,132090) = NaN;
pres2(1:33,135673) = NaN;
pres2(:,135674) = NaN;
pres2(1:7,135838) = NaN;
...
for i = 266:length(ind)
    ...
    bad(i) = input('0 for good, 1 for bad');
    end
end
...
save /home/alison/Matlab/Mat' files'/Global' Mapping 2'/South' Pacific'/profiles_final.mat
