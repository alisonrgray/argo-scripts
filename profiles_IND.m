...
load /home/alison/Matlab/Mat' files'/Global' Mapping 2'/Indian/profiles_IND.mat
load /home/alison/Matlab/Mat' files'/Global' Mapping 2'/Indian/profiles_QC_IND.mat
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2005.mat');

clear; pack;
load /home/alison/Matlab/Mat' files'/Global' Mapping 2'/Indian/profiles_adj_IND.mat
t1 = datenum(2005,01,01);
t2 = datenum(2006,01,01);
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_adj_2005.mat');

clear; pack;
load /home/alison/Matlab/Mat' files'/Global' Mapping 2'/Indian/profiles_err_IND.mat
load /home/alison/Matlab/Mat' files'/Global' Mapping 2'/Indian/profiles_adj_IND.mat time_adj
t1 = datenum(2005,01,01);
t2 = datenum(2006,01,01);
ind = find(time_adj >= t1 & time_adj <= t2);
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_err_2005.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2006.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_adj_2006.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_err_2006.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2007.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_adj_2007.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_err_2007.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2008.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_adj_2008.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_err_2008.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2009.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_adj_2009.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_err_2009.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2010.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_adj_2010.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_err_2010.mat');


%% 2005
clear; pack
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_2005.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_adj_2005.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_err_2005.mat;
...
figure(1); clf
axesm('mercator','MapLatLimit',[-85 35],'MapLonLimit',[20 130])
...
% lat/lon range
ind = find(longitude <= 130 & longitude >= 25 & latitude <= 22 & latitude >= -80);
...
ind = find(~(longitude >= 120 & latitude >= -5));
temp = temp(:,ind); latitude = latitude(ind); longitude = longitude(ind); time = time(ind); pres = pres(:,ind);
psal = psal(:,ind); fnum = fnum(ind); type = type(ind);
temp_qc = temp_qc(:,ind); pres_qc = pres_qc(:,ind); psal_qc = psal_qc(:,ind);
position_qc = position_qc(ind); juld_qc = juld_qc(ind); prof_temp_qc = prof_temp_qc(ind);
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat num_800
clear num_800 maxp
...
save /home/alison/Matlab/M'at files'/Global' Mapping 2'/Indian/tmp.mat

% graylist floats
cd('/home/alison/Matlab/M files/Global Mapping 2/');
[grayfloat,~,start_date,end_date,errtype] = graylist('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/');
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat num_badQC -APPEND
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat num_800_2
...
% save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat num_percentNaN -APPEND
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat num_shortprof -APPEND
clear num_shortprof
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat num_gray -APPEND
...
% graylist floats
cd('/home/alison/Matlab/M files/Global Mapping 2/');
[grayfloat,param,start_date,end_date,errtype] = graylist('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/');
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat num_lowS -APPEND
...
% save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat num_errant -APPEND
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat num_800_3 -APPEND
...
for i = 1:length(indnum)
    ...
    filename = strcat('/home/alison/Data/Argo Profiles/Float/Indian/','Profiles/',fn,'_prof.nc');
...
%% %%%%%%%%%%%%%%%
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2005_qc_all.mat');   
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2005_qc.mat');

clear; load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats_2005.mat


%% 2006
clear; pack
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_2006.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_adj_2006.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_err_2006.mat;
...
% lat/lon range
ind = find(longitude <= 130 & longitude >= 25 & latitude <= 26 & latitude >= -80);
temp = temp(:,ind); latitude = latitude(ind); longitude = longitude(ind); time = time(ind); pres = pres(:,ind);
psal = psal(:,ind); fnum = fnum(ind); type = type(ind);
temp_qc = temp_qc(:,ind); pres_qc = pres_qc(:,ind); psal_qc = psal_qc(:,ind);
position_qc = position_qc(ind); juld_qc = juld_qc(ind); prof_temp_qc = prof_temp_qc(ind);
...
ind = find(~(longitude >= 116 & latitude >= 18));
temp = temp(:,ind); latitude = latitude(ind); longitude = longitude(ind); time = time(ind); pres = pres(:,ind);
psal = psal(:,ind); fnum = fnum(ind); type = type(ind);
temp_qc = temp_qc(:,ind); pres_qc = pres_qc(:,ind); psal_qc = psal_qc(:,ind);
position_qc = position_qc(ind); juld_qc = juld_qc(ind); prof_temp_qc = prof_temp_qc(ind);
...
%% %%%%%%%%%%%%%%%
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2006_qc_all.mat');   

clear juld_qc percentNaN position_qc pqc pres pres_qc prof_* psal psal_qc sqc dir_name indnum temp temp_qc tqc
pres = pres2; psal = psal2; temp = temp2; clear pres2 psal2 temp2 pres_adj pres_qc_adj psal_adj psal_qc_adj temp_adj temp_qc_adj time_adj

save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2006_qc.mat');

clear; load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats_2006.mat

%% 2007
clear; pack
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_2007.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_adj_2007.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_err_2007.mat;
...
ind = find(~(longitude >= 105 & latitude >= 2));
temp = temp(:,ind); latitude = latitude(ind); longitude = longitude(ind); time = time(ind); pres = pres(:,ind);
psal = psal(:,ind); fnum = fnum(ind); type = type(ind);
temp_qc = temp_qc(:,ind); pres_qc = pres_qc(:,ind); psal_qc = psal_qc(:,ind);
position_qc = position_qc(ind); juld_qc = juld_qc(ind); prof_temp_qc = prof_temp_qc(ind);
...
temp2(ind3(6),ii(ind2(5))) = NaN;
temp2(ind3(8),ii(ind2(7))) = NaN;
temp2(ind3(10),ii(ind2(9))) = NaN;
...
[i,j] = find(pres2 > 1700 & temp2 > 6.4);
pres2(i,j) = NaN;

[i,j] = find(pres2 > 1800 & psal2 < 34);
pres2(:,j) = NaN;
...
%% %%%%%%%%%%%%%%%
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2007_qc_all.mat');   

clear juld_qc percentNaN position_qc pqc pres pres_qc prof_* psal psal_qc sqc dir_name indnum temp temp_qc tqc
pres = pres2; psal = psal2; temp = temp2; clear pres2 psal2 temp2 pres_adj pres_qc_adj psal_adj psal_qc_adj temp_adj temp_qc_adj time_adj

save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2007_qc.mat');

clear; load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats_2007.mat

%% 2008
clear; pack
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_2008.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_adj_2008.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_err_2008.mat;
...
ind = find(~(longitude >= 105 & latitude >= 0));
temp = temp(:,ind); latitude = latitude(ind); longitude = longitude(ind); time = time(ind); pres = pres(:,ind);
psal = psal(:,ind); fnum = fnum(ind); type = type(ind);
temp_qc = temp_qc(:,ind); pres_qc = pres_qc(:,ind); psal_qc = psal_qc(:,ind);
position_qc = position_qc(ind); juld_qc = juld_qc(ind); prof_temp_qc = prof_temp_qc(ind);
...
i = 1;
temp2(417:495,ii(31)) = NaN;
temp2(664:751,ii(33)) = NaN;
temp2(445:495,ii(61)) = NaN;
temp2(427:490,ii(81)) = NaN;
temp2(452:474,ii(85)) = NaN;
temp2(419:423,ii(85)) = NaN;
temp2(434,ii(85)) = NaN;
temp2(501,ii(129)) = NaN;
temp2(450:484,ii(129)) = NaN;
temp2(437:438,ii(129)) = NaN;
temp2(521,ii(157)) = NaN;
temp2(453,ii(157)) = NaN;
temp2(470:476,ii(157)) = NaN;
temp2(492:496,ii(157)) = NaN;
temp2(510:511,ii(157)) = NaN;

i = 2;
temp2(409:485,ii(39)) = NaN;
temp2(444,ii(67)) = NaN;
temp2(464:489,ii(67)) = NaN;
temp2(421:496,ii(103)) = NaN;
...
for jj = 1:2:length(ind2)
temp2(ind3(jj+1),ii(ind2(jj))) = NaN;
end

clear ii iii ind ind1 ind2 ind3 j jj s t p pp
...
[i,j] = find(pres2 > 1540 & temp2 > 7.8);
for k = 1:length(i)
    pres2(i(k),j(k)) = NaN;
end

[i,j] = find(pres2 > 1000 & psal2 < 32.9);
pres2(:,j) = NaN;
...
%% %%%%%%%%%%%%%%%
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2008_qc_all.mat');   

clear juld_qc percentNaN position_qc pqc pres pres_qc prof_* psal psal_qc sqc dir_name indnum temp temp_qc tqc
pres = pres2; psal = psal2; temp = temp2; clear pres2 psal2 temp2 pres_adj pres_qc_adj psal_adj psal_qc_adj temp_adj temp_qc_adj time_adj

save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2008_qc.mat');

clear; load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats_2008.mat

%% 2009
clear; pack
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_2009.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_adj_2009.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_err_2009.mat;
...
%% %%%%%%%%%%%%%%%
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2009_qc_all.mat');   

clear juld_qc percentNaN position_qc pqc pres pres_qc prof_* psal psal_qc sqc dir_name indnum temp temp_qc tqc
pres = pres2; psal = psal2; temp = temp2; clear pres2 psal2 temp2 pres_adj pres_qc_adj psal_adj psal_qc_adj temp_adj temp_qc_adj time_adj

save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2009_qc.mat');

clear; load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats_2009.mat

%% 2010
clear; pack
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_2010.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_adj_2010.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/prof_err_2010.mat;
...
%% %%%%%%%%%%%%%%%
save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2010_qc_all.mat');   

clear juld_qc percentNaN position_qc pqc pres pres_qc prof_* psal psal_qc sqc dir_name indnum temp temp_qc tqc
pres = pres2; psal = psal2; temp = temp2; clear pres2 psal2 temp2 pres_adj pres_qc_adj psal_adj psal_qc_adj temp_adj temp_qc_adj time_adj

save('/home/alison/Matlab/Mat files/Global Mapping 2/Indian/prof_2010_qc.mat');

clear; load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats.mat
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/Indian/bad_floats_2010.mat
