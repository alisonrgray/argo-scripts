...
load /home/alison/Matlab/Mat' files'/Global' Mapping 2'/South' Atlantic'/profiles_SA.mat
load /home/alison/Matlab/Mat' files'/Global' Mapping 2'/South' Atlantic'/profiles_QC_SA.mat
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2005.mat');

clear; pack;
load /home/alison/Matlab/Mat' files'/Global' Mapping 2'/South' Atlantic'/profiles_adj_SA.mat
t1 = datenum(2005,01,01);
t2 = datenum(2006,01,01);
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_adj_2005.mat');

clear; pack;
load /home/alison/Matlab/Mat' files'/Global' Mapping 2'/South' Atlantic'/profiles_err_SA.mat
load /home/alison/Matlab/Mat' files'/Global' Mapping 2'/South' Atlantic'/profiles_adj_SA.mat time_adj
t1 = datenum(2005,01,01);
t2 = datenum(2006,01,01);
ind = find(time_adj >= t1 & time_adj <= t2);
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_err_2005.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2006.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_adj_2006.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_err_2006.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2007.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_adj_2007.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_err_2007.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2008.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_adj_2008.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_err_2008.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2009.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_adj_2009.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_err_2009.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2010.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_adj_2010.mat');
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_err_2010.mat');
...
% 2005
clear; pack
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_2005.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_adj_2005.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_err_2005.mat;
...
figure(1); clf
axesm('mercator','MapLatLimit',[-85 5],'MapLonLimit',[-100 50])
...
% lat/lon range
ind = find(longitude <= 30 & longitude >= -75 & latitude <= 0 & latitude >= -80);
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat num_800
clear num_800 maxp
...
save /home/alison/Matlab/M'at files'/Global' Mapping 2'/South' Atlantic'/tmp.mat

% graylist floats
cd('/home/alison/Matlab/M files/Global Mapping 2/');
[grayfloat,~,start_date,end_date,errtype] = graylist('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/');
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat num_badQC -APPEND
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat num_800_2
...
% save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat num_percentNaN -APPEND
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat num_shortprof -APPEND
clear num_shortprof
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat num_gray -APPEND
...
% graylist floats
cd('/home/alison/Matlab/M files/Global Mapping 2/');
[grayfloat,param,start_date,end_date,errtype] = graylist('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/');
...
ind = find(pres > 2100); length(ind)
[i,j] = find(pres2 > 2100); length(i)
tempnum = fnum(j);
presnum = 0; k = 1;
...
% pres2(1,ind(8:10)) = NaN;
% fnumb = [fnumb; fnum(ind(8:10))];
% timeb = [timeb; time(ind(8:10))];
% 
% i = 2;
% pres2(1,ind(4)) = NaN;
% pres2(1,ind(10)) = NaN;
% pres2(1,ind(12)) = NaN;
% pres2(1,ind(15)) = NaN;
% fnumb = [fnumb; fnum(ind(4))];
% timeb = [timeb; time(ind(4))];
% fnumb = [fnumb; fnum(ind(10))];
% timeb = [timeb; time(ind(10))];
% fnumb = [fnumb; fnum(ind(12))];
% timeb = [timeb; time(ind(12))];
% fnumb = [fnumb; fnum(ind(15))];
% timeb = [timeb; time(ind(15))];

num_lowS = [fnumb timeb];
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat num_lowS -APPEND
...
figure(3); clf
plot(psal2,temp2,'.-'); grid on; axis tight;

fnumb = []; timeb = [];

% [~,j] = find(temp2 > 8 & pres2 > 1200);
% badnum = fnum(j(1))
% 
% [~,j] = find(psal2 > 35.1 & pres2 > 1200);
% badnum = fnum(j(1))
% 
% [~,j] = find(psal2 > 34.8 & temp2 < 1.5);
% badnum = fnum(j(3))
% badnum = fnum(j(7))
% badnum = fnum(j(end))
% badnum = fnum(j(1))
% 
% [~,j] = find(psal2 > 34.6 & temp2 < -1);
% badnum = fnum(j(1))
% 
% [~,j] = find(psal2 > 34.78 & temp2 < 1.8 & temp2 > 1.6);
% badnum = fnum(j(1))
% 
% [~,j] = find(psal2 > 35.6 & temp2 < 14.49 & temp2 > 14.48);
% badnum = fnum(j(1))
% 
% [~,j] = find(psal2 > 36.24 & temp2 < 17.5 & temp2 > 17.4);
% badnum = fnum(j(1))
% 
% 
% i = 1; jj = 5;
% pres2(45,ind(jj)) = NaN;
% fnumb = [fnumb; fnum(ind(jj))]; timeb = [timeb; time(ind(jj))];
% 
% i = 1; jj = 1;
% pres2(:,ind(jj)) = NaN;
% fnumb = [fnumb; fnum(ind(jj))]; timeb = [timeb; time(ind(jj))];
...
% 
% i = 1;
% ind = find((temp2(57,:))' == 0 & fnum == badnum(i));
% pres2(57,ind) = NaN;
% fnumb = [fnumb; fnum(ind)]; timeb = [timeb; time(ind)];
% 
% i = 1; 
% pres2(:,ind) = NaN;
% fnumb = [fnumb; fnum(ind)]; timeb = [timeb; time(ind)];
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat num_errant -APPEND
...
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat num_800_3 -APPEND
...
for i = 1:length(indnum)
    ...
    filename = strcat('/home/alison/Data/Argo Profiles/Float/South Atlantic/','Profiles/',fn,'_prof.nc');
...
clear PI ans filename fn i ind indnum indnum2 nc pi 

%% %%%%%%%%%%%%%%%
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2005_qc_all.mat');   
...
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2005_qc.mat');

clear; load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats_2005.mat

%% quality control

% 2006
clear; pack
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_2006.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_adj_2006.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_err_2006.mat;
...
% set bad values to Nan
pres2(1,ind(21)) = NaN;
fnumb = [fnumb; fnum(ind(21))];
timeb = [timeb; time(ind(21))];
...
%% %%%%%%%%%%%%%%%
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2006_qc_all.mat');   

clear juld_qc percentNaN position_qc pqc pres pres_qc prof_* psal psal_qc sqc dir_name indnum temp temp_qc tqc
pres = pres2; psal = psal2; temp = temp2; clear pres2 psal2 temp2 pres_adj pres_qc_adj psal_adj psal_qc_adj temp_adj temp_qc_adj time_adj

save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2006_qc.mat');

clear; load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats_2006.mat
...
% 2007
clear; pack
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_2007.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_adj_2007.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_err_2007.mat;
...
%% %%%%%%%%%%%%%%%
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2007_qc_all.mat');   

clear juld_qc percentNaN position_qc pqc pres pres_qc prof_* psal psal_qc sqc dir_name indnum temp temp_qc tqc
pres = pres2; psal = psal2; temp = temp2; clear pres2 psal2 temp2 pres_adj pres_qc_adj psal_adj psal_qc_adj temp_adj temp_qc_adj time_adj

save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2007_qc.mat');

clear; load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats_2007.mat
...
% 2008
clear; pack
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_2008.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_adj_2008.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_err_2008.mat;
...
% set bad values to Nan
pres2(:,ind(:)) = NaN;
fnumb = [fnumb; fnum(ind(:))];
timeb = [timeb; time(ind(:))];
...
%% %%%%%%%%%%%%%%%
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2008_qc_all.mat');   

clear juld_qc percentNaN position_qc pqc pres pres_qc prof_* psal psal_qc sqc dir_name indnum temp temp_qc tqc
pres = pres2; psal = psal2; temp = temp2; clear pres2 psal2 temp2 pres_adj pres_qc_adj psal_adj psal_qc_adj temp_adj temp_qc_adj time_adj

save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2008_qc.mat');

clear; load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats_2008.mat
...
% 2009
clear; pack
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_2009.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_adj_2009.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_err_2009.mat;
...
%% %%%%%%%%%%%%%%%
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2009_qc_all.mat');   

clear juld_qc percentNaN position_qc pqc pres pres_qc prof_* psal psal_qc sqc dir_name indnum temp temp_qc tqc
pres = pres2; psal = psal2; temp = temp2; clear pres2 psal2 temp2 pres_adj pres_qc_adj psal_adj psal_qc_adj temp_adj temp_qc_adj time_adj

save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2009_qc.mat');

clear; load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats_2009.mat
...
% 2010
clear; pack
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_2010.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_adj_2010.mat;
load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/prof_err_2010.mat;
...
% latitude = latitude(ind); longitude = longitude(ind); time = time(ind); fnum = fnum(ind); type = type(ind);
% pres = pres(:,ind); psal = psal(:,ind); temp = temp(:,ind);
% pres_err = pres_err(:,ind); psal_err = psal_err(:,ind); temp_err = temp_err(:,ind);
% datamode = datamode(ind);
...
%% %%%%%%%%%%%%%%%
save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2010_qc_all.mat');   

clear juld_qc percentNaN position_qc pqc pres pres_qc prof_* psal psal_qc sqc dir_name indnum temp temp_qc tqc
pres = pres2; psal = psal2; temp = temp2; clear pres2 psal2 temp2 pres_adj pres_qc_adj psal_adj psal_qc_adj temp_adj temp_qc_adj time_adj

save('/home/alison/Matlab/Mat files/Global Mapping 2/South Atlantic/prof_2010_qc.mat');

clear; load /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats.mat
save /home/alison/Matlab/Ma't files'/Global' Mapping 2'/South' Atlantic'/bad_floats_2010.mat
